...
# %% ../../nbs/Environments/11_EnvEcologicalPublicGood.ipynb #4f510399-524c-4756-bfc9-d791de43ab18
...
# %% ../../nbs/Environments/11_EnvEcologicalPublicGood.ipynb #9446dc68-1fb3-4e54-8425-65da84ebfcaa
...
# %% ../../nbs/Environments/11_EnvEcologicalPublicGood.ipynb #cf48ea1e-aa4c-4cba-a181-9675fa413b7e
@patch
def actions(self:EcologicalPublicGood):
    """The action sets"""
    return [['c', 'd'] for _ in range(self.N)]

# %% ../../nbs/Environments/11_EnvEcologicalPublicGood.ipynb #5c9f4575-0816-4eab-8305-491192b48b04
@patch
def states(self:EcologicalPublicGood):
    """The states set"""
    return ['g', 'p'] 

# %% ../../nbs/Environments/11_EnvEcologicalPublicGood.ipynb #807ce783-63e5-402d-bb92-f42fea047254
@patch
...
# %% ../../nbs/Environments/11_EnvEcologicalPublicGood.ipynb #8ca66c71-1ab3-4514-ab1b-15984e6bb6b2
@patch
...
# %% ../../nbs/Environments/11_EnvEcologicalPublicGood.ipynb #395c7eb5-c6c4-43cb-9408-8278d319051f
@patch
