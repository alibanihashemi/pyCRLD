# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/Environments/101_EnvSocialDilemmaAsym.ipynb.

# %% auto #0
__all__ = ['SocialDilemmaAsym']

# %% ../../nbs/Environments/101_EnvSocialDilemmaAsym.ipynb #ee548608
__all__ = ['SocialDilemmaAsym']




# %% ../../nbs/Environments/101_EnvSocialDilemmaAsym.ipynb #c63224c7
...
# %% ../../nbs/Environments/101_EnvSocialDilemmaAsym.ipynb #a07968f6
class SocialDilemmaAsym(ebase):
    """
    Numpy version of a 2-agent 2-action Social Dilemma Matrix Game.
...
# %% ../../nbs/Environments/101_EnvSocialDilemmaAsym.ipynb #24d725e7
@patch
def TransitionTensor(self: SocialDilemmaAsym):
    """Get the Transition Tensor."""
    Tsas = np.ones((self.Z, self.M, self.M, self.Z))
    return Tsas


# %% ../../nbs/Environments/101_EnvSocialDilemmaAsym.ipynb #25d9700c
@patch
def RewardTensor(self: SocialDilemmaAsym):
...
# %% ../../nbs/Environments/101_EnvSocialDilemmaAsym.ipynb #8665b8d0
@patch
def actions(self:SocialDilemmaAsym):
    """The action sets"""
...
# %% ../../nbs/Environments/101_EnvSocialDilemmaAsym.ipynb #c2776f51
@patch
def states(self:SocialDilemmaAsym):
    """The states set"""
    return ['.'] 
...
# %% ../../nbs/Environments/101_EnvSocialDilemmaAsym.ipynb #fd3c39a3
@patch
def id(self:SocialDilemmaAsym):
    """
